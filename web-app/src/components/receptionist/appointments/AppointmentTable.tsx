                ...
                <table className="w-full">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {appointments.length === 0 ? (
                            <tr>
                                <td colSpan={8} className="text-center py-8 text-gray-400 text-base font-medium">
                                    <span className="inline-flex flex-col items-center gap-2">
                                        ...
                                        Không có lịch hẹn nào cho ngày này.<br/>Hãy thử chọn ngày khác hoặc tạo mới lịch hẹn!
                                    </span>
                                </td>
                            </tr>
                        ) : (
