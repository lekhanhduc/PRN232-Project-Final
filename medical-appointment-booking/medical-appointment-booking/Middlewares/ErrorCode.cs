...
namespace medical_appointment_booking.Middlewares
{
    public class ErrorCode
    {
        ...
        public static readonly ErrorCode USER_EXISTED = new ErrorCode(404, "User already exists, please select another phone number or email", HttpStatusCode.NotFound);
